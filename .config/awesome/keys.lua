...
keys.globalkeys = gears.table.join(
    ...
    awful.key({'Mod1', 'Shift'}, 'Tab', function() awful.client.focus.byidx(-1) end,
              {description = 'Switch backwards between windows', group = 'Window Management'}),
    ...
    awful.key({metakey}, 'Up', function () awful.tag.incnmaster(1, nil, true) end,
              {description = 'Increase number of master clients', group = 'Window Management'}),
    awful.key({metakey}, 'Down', function () awful.tag.incnmaster(-1, nil, true) end,
              {description = 'Decrease number of master clients', group = 'Window Management'}),
    awful.key({metakey, 'Shift'}, "Right", function() awful.client.swap.byidx( 1) end,
              {description = "Swap with next client by index", group = "Window Management"}),
    awful.key({metakey, 'Shift'}, "Left", function() awful.client.swap.byidx( -1) end,
    ...
    awful.key({metakey}, 'F1', function() awful.util.spawn('amixer set Master toggle') end,
    ...
    -- Prompt
    awful.key({metakey}, 'r', function() awful.screen.focused().mypromptbox:run() end,

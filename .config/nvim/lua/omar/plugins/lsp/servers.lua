...
vim.keymap.set("n", "<C-n>", vim.diagnostic.goto_next, { desc = "Move to next diagnostic" })
vim.keymap.set("n", "<C-p>", vim.diagnostic.goto_prev, { desc = "Move to previous diagnostic" })
